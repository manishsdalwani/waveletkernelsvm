...
saveas(h,sprintf('ROC_linearSVM_cautious_ctrlspts_%d.png',k)); % will create FIG1, FIG2,...
end
...
saveas(h,sprintf('Confusion Matrix Linear SVM Cautious Decision Controls vs Patients.png'));
