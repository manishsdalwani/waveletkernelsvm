...
xlabel('False positive rate')
ylabel('True positive rate')
title('ROC for SVM Classification (Kernel="MexicanHat")');
saveas(h,sprintf('simdata_ROC_MexicanHatSVM_%d.png',k)); % will create FIG1, FIG2,...
end
...
filename = 'simdata_MexicanHat_SVM.xlsx';
...
saveas(h,sprintf('simdata Confusion Matrix MexicanHat SVM.png'));