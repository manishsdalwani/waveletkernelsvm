...
saveas(h,sprintf('ROI%s_ROC_LinearSVM_Risky_boysgirls_%d.png',rois,k)); % will create FIG1, FIG2,...
end
...
%Final Data measures
finaldatasave(roi,:)=[100*bal_Accuracy kappa Precision_weighted Recall_weighted Fscore_weighted auc_roc_final(2)];
...
saveas(h,sprintf('ROI%sConfusion Matrix Linear SVM Risky Decision boys vs girls.png',rois));
elapsed_time = [elapsed_time toc];
end
dlmwrite('Linear_Risky_boys_vs_girls_2.csv', finaldatasave, 'Delimiter',',');      
dlmwrite('bestparams_Linear_Risky_boys_vs_girls.csv', besthyperparameters, 'Delimiter',',');
totaltime = toc;
dlmwrite('timetakenperROI_Linear_Risky_boys_vs_girls.csv', elapsed_time, 'Delimiter',',');