...
saveas(h,sprintf('ROI%s_ROC_MHSVM_Risky_BoysGirls_%d.png',rois,k)); % will create FIG1, FIG2,...
end
...
saveas(h,sprintf('ROI%sConfusion Matrix MH SVM Risky Decision Boys vs Girls.png',rois));
...
dlmwrite('MH_Risky_Boys_vs_Girls.csv', finaldatasave, 'Delimiter',',');      
dlmwrite('bestparams_MH_Risky_Boys_vs_Girls.csv', besthyperparameters, 'Delimiter',',');
totaltime = toc;
dlmwrite('timetakenperROI_MH_Risky_Boys_vs_Girls.csv', elapsed_time, 'Delimiter',',');