...
saveas(h,sprintf('ROI8_ROC_striatum_MultiScaleMexicanHatSVM_Risky_boysgirls_%d.png',k)); % will create FIG1, FIG2,...
end
...
filename = 'roi_ROI8_MultiScaleMexicanHat_SVM_boys_vs_girls_risky.xlsx';
...
saveas(h,sprintf('ROI8 Confusion Matrix Striatum Multiscale Mexican Hat SVM risky Decision Boys vs Girls.png'));
