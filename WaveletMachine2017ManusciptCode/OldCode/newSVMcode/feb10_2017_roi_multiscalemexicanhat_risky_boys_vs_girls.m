...
filename = 'roi_striatum_MultiScaleMexicanHat_SVM_boys_vs_girls_risky.xlsx';
...
saveas(h,sprintf('Confusion Matrix Striatum Multiscale Mexican Hat SVM risky Decision Boys vs Girls.png'));
