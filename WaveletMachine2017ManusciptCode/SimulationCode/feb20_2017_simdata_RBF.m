...
xlabel('False positive rate')
ylabel('True positive rate')
title('ROC for SVM Classification (Kernel="RBF")');
saveas(h,sprintf('simdata_ROC_RBFSVM_%d.png',k)); % will create FIG1, FIG2,...
end
...
saveas(h,sprintf('simdata Confusion Matrix Adapative SVM.png'));