...
saveas(h,sprintf('ROI1_ROC_morletSVM_risky_controlspatients_%d.png',k)); % will create FIG1, FIG2,...
end
...
filename = 'ROI1_morlet_SVM_controls_vs_patients_risky.xlsx';
...
saveas(h,sprintf('ROI1 Confusion Matrix morlet SVM Risky Decision controls vs patients.png'));