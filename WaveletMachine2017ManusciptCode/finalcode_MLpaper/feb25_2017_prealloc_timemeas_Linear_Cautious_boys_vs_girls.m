...
saveas(h,sprintf('Wholebrain_ROC_LinearSVM_Cautious_boysgirls_%d.png',k)); % will create FIG1, FIG2,...
end
...
saveas(h,sprintf('WholeBrain Confusion Matrix Linear SVM Cautious Decision boys vs girls.png'));
...
filename = 'wholebrain_Linear_SVM_boys_vs_girls_Cautious.xlsx';
...
saveas(h,sprintf('wholebrain Confusion Matrix Linear SVM Cautious Decision boys vs girls.png'));
elapsed_time=toc
dlmwrite('timetaken_Linear_Cautious_boys_vs_girls.csv', elapsed_time, 'Delimiter',',');