...
%K3 =  [ (1:numTrain)', rbfKernel2(SortedData(trainRows ,3:features(2)),SortedData(trainRows ,3:features(2)))];
%KK2 = [ (1:81)', rbfKernel3(SortedData(:,3:features(2)),SortedData(:,3:features(2)))];
