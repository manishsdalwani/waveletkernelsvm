...
saveas(h,sprintf('ROI7_ROC_RBFSVM_risky_boysgirls_%d.png',k)); % will create FIG1, FIG2,...
end
...
filename = 'roi_ROI7_RBF_SVM_boys_vs_girls_risky.xlsx';
...
saveas(h,sprintf('ROI7 Confusion Matrix RBF SVM Risky Decision Boys vs Girls.png'));
