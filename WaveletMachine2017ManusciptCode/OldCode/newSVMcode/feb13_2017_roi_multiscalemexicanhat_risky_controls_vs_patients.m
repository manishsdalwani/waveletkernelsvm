...
saveas(h,sprintf('ROI%s_ROC_MultiscaleMexicanHatSVM_risky_controlspatients_%d.png',rois,k)); % will create FIG1, FIG2,...
end
...
filename = 'roi_MultiscaleMexicanHat_SVM_controls_vs_patients_risky.xlsx';
...
saveas(h,sprintf('ROI%sConfusion Matrix Multiscale Mexican Hat SVM Risky Decision controls vs patients.png',rois));
end
