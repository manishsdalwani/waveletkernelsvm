...
saveas(h,sprintf('ROI2_ROC_striatum_MexicanHatSVM_Risky_boysgirls_%d.png',k)); % will create FIG1, FIG2,...
end
...
filename = 'roi_ROI2_MexicanHat_SVM_boys_vs_girls_risky.xlsx';
...
saveas(h,sprintf('ROI2_Confusion Matrix Striatum Mexican Hat SVM risky Decision Boys vs Girls.png'));
