...
saveas(h,sprintf('ROI%s_ROC_MultiMHSVM_Cautious_boysgirls_%d.png',rois,k)); % will create FIG1, FIG2,...
end
...
saveas(h,sprintf('ROI%sConfusion Matrix MultiMH SVM Cautious Decision boys vs girls.png',rois));
elapsed_time = [elapsed_time toc];
end
dlmwrite('MultiMH_Cautious_boys_vs_girls.csv', finaldatasave, 'Delimiter',',');      
dlmwrite('bestparams_MultiMH_Cautious_boys_vs_girls.csv', besthyperparameters, 'Delimiter',',');
totaltime = toc;
dlmwrite('timetakenperROI_MultiMH_Cautious_boys_vs_girls.csv', elapsed_time, 'Delimiter',',');