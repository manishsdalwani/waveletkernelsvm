...
saveas(h,sprintf('ROI%s_ROC_MultiscaleMexicanHatSVM_Risky_boysgirls_%d.png',rois,k)); % will create FIG1, FIG2,...
end
...
filename = 'roi_MultiscaleMexicanHat_SVM_boys_vs_girls_Risky.xlsx';
...
saveas(h,sprintf('ROI%sConfusion Matrix Multiscale Mexican Hat SVM Risky Decision boys vs girls.png',rois));
end
