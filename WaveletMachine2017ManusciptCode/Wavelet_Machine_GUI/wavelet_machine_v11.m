function varargout = wavelet_machine_v11(varargin)
% WAVELET_MACHINE_V11 MATLAB code for wavelet_machine_v11.fig
%      WAVELET_MACHINE_V11, by itself, creates a new WAVELET_MACHINE_V11 or raises the existing
%      singleton*.
%
%      H = WAVELET_MACHINE_V11 returns the handle to a new WAVELET_MACHINE_V11 or the handle to
%      the existing singleton*.
%
%      WAVELET_MACHINE_V11('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in WAVELET_MACHINE_V11.M with the given input arguments.
%
%      WAVELET_MACHINE_V11('Property','Value',...) creates a new WAVELET_MACHINE_V11 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before wavelet_machine_v11_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to wavelet_machine_v11_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help wavelet_machine_v11

% Last Modified by GUIDE v2.5 25-May-2017 15:48:22

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @wavelet_machine_v11_OpeningFcn, ...
    'gui_OutputFcn',  @wavelet_machine_v11_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before wavelet_machine_v11 is made visible.
function wavelet_machine_v11_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to wavelet_machine_v11 (see VARARGIN)

% Choose default command line output for wavelet_machine_v11
...
% UIWAIT makes wavelet_machine_v11 wait for user response (see UIRESUME)
...
function varargout = wavelet_machine_v11_OutputFcn(hObject, eventdata, handles)
