...
% The modified Mexican Hat Wavelet Kernel with the tuned parameters
...
xlabel('False positive rate')
ylabel('True positive rate')
title('ROC for SVM Classification (Kernel="Mexican Hat") during Cautious Decision')
saveas(h,sprintf('ROC_striatum_MexicanHatSVM_cautious_boysgirls_%d.png',k)); % will create FIG1, FIG2,...
end
...
filename = 'roi_striatum_MexicanHat_SVM_boys_vs_girls_cautious.xlsx';
...
saveas(h,sprintf('Confusion Matrix Striatum Mexican Hat SVM Cautious Decision Boys vs Girls.png'));
