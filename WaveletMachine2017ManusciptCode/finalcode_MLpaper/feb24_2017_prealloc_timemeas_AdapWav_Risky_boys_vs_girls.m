...
saveas(h,sprintf('ROI%s_ROC_AdaptiveSVM_Risky_BoysGirls_%d.png',rois,k)); % will create FIG1, FIG2,...
end
...
saveas(h,sprintf('ROI%sConfusion Matrix Adaptive SVM Risky Decision Boys vs Girls.png',rois));
elapsed_time = [elapsed_time toc];
end
dlmwrite('Adaptive_Risky_Boys_vs_Girls.csv', finaldatasave, 'Delimiter',',');      
dlmwrite('bestparams_Adaptive_Risky_Boys_vs_Girls.csv', besthyperparameters, 'Delimiter',',');
totaltime = toc;
dlmwrite('timetakenperROI_Adaptive_Risky_Boys_vs_Girls.csv', elapsed_time, 'Delimiter',',');