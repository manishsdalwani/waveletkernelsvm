...
% Base directory modify as per your own{"IsDistinguishedFolder":true,"FolderId":{"Id":"AAMkAGEwOGZhZDk0LTc3YjItNGE1NS05MDk4LTY0MjlkMTM1YzcyMQAuAAAAAADRAsWRsL3yTalejgi/CAk0AQD8sk2sdPwnRrKmtFItaa8eAAABxnOqAAA=","ChangeKey":"AQAAABYAAACiKoQGDyC/RYEprk8WzohLAANmwhh+"},"DragItemType":3}
...
saveas(h,sprintf('Wholebrain_ROC_morletSVM_Cautious_boysgirls_%d.png',k)); % will create FIG1, FIG2,...
end
...
saveas(h,sprintf('WholeBrain Confusion Matrix morlet SVM Cautious Decision boys vs girls.png'));
...
filename = 'wholebrain_morlet_SVM_boys_vs_girls_Cautious.xlsx';
...
saveas(h,sprintf('wholebrain Confusion Matrix morlet SVM Cautious Decision boys vs girls.png'));
elapsed_time=toc
dlmwrite('timetaken_morlet_Cautious_boys_vs_girls.csv', elapsed_time, 'Delimiter',',');