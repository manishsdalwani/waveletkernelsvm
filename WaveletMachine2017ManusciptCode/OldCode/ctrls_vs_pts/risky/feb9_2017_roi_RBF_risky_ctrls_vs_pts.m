...
saveas(h,sprintf('ROC_RBFSVM_Risky_controlspatients_%d.png',k)); % will create FIG1, FIG2,...
end
...
filename = 'roi_RBF_SVM_controls_vs_patients_risky.xlsx';
...
saveas(h,sprintf('Confusion Matrix RBF SVM Risky Decision controls vs patients.png'));
