function[bestc, bestsigma, bestsigma2, bestcv] = TwoHyperPar(Range1,Range2,Range3,Kernel,dataRowNumber,FeatMat1,FeatMat2,cvloop_parmselect,labels)
...
for i = 1:length(Range1)
    ...
    for j = 1:length(Range2)
        ...
        for k = 1:length(Range3)
            ...
            K =  [ (1:dataRowNumber)', Kernel(FeatMat1,FeatMat2,sigma,sigma2)];
