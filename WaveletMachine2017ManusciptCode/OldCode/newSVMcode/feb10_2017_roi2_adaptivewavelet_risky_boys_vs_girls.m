...
saveas(h,sprintf('ROI2_ROC_striatum_AdaptiveWaveletSVM_Risky_boysgirls_%d.png',k)); % will create FIG1, FIG2,...
end
...
filename = 'roi_ROI2_AdaptiveWavelet_SVM_boys_vs_girls_risky.xlsx';
...
saveas(h,sprintf('ROI2 Confusion Matrix Striatum AdaptiveWavelet SVM risky Decision Boys vs Girls.png'));
