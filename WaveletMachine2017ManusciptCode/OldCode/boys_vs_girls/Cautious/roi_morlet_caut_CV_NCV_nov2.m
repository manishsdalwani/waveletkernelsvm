...
for s=1:numsubjects
    ...
    ALLsubs(CURRENTsub,:) = reshape(fmri_masked_vector, 1, 464870);
end;
...
numTrain = size(SortedData(trainRows ,3:188357) ,1);
numTest = size(SortedData(testRows ,3:188357) ,1);
...
for log2c = -3.1:3.1,
  for log2g = -20.1:20.1,
     ...
     K =  [ (1:numTrain)', rbfKernel(SortedData(trainRows ,3:188357),SortedData(trainRows ,3:188357))];
...
K2 =  [ (1:numTrain)', rbfKernel2(SortedData(trainRows ,3:188357),SortedData(trainRows ,3:188357))];
KK = [ (1:numTest)', rbfKernel2(SortedData(testRows,3:188357),SortedData(trainRows ,3:188357))];
