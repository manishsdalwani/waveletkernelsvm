...
% June 25th learned not to concatenate the values from each loop
% Glad to see was doing the right thing for ROC and AUC. 
...
saveas(h,sprintf('ROI%s_ROC_LinearSVM_Cautious_boysgirls_%d.png',rois,k)); % will create FIG1, FIG2,...
end
...
saveas(h,sprintf('ROI%sConfusion Matrix Linear SVM Cautious Decision boys vs girls.png',rois));
elapsed_time = [elapsed_time toc];
end
dlmwrite('Linear_Cautious_boys_vs_girls.csv', finaldatasave, 'Delimiter',',');      
dlmwrite('bestparams_Linear_Cautious_boys_vs_girls.csv', besthyperparameters, 'Delimiter',',');
totaltime = toc;
dlmwrite('timetakenperROI_Linear_Cautious_boys_vs_girls.csv', elapsed_time, 'Delimiter',',');