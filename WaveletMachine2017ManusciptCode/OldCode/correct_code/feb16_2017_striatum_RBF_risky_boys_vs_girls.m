...
saveas(h,sprintf('Striatum_ROC_RBFSVM_risky_boysgirls_%d.png',k)); % will create FIG1, FIG2,...
end
...
filename = 'Striatum_RBF_SVM_boys_vs_girls_Risky.xlsx';
...
saveas(h,sprintf('Striatum Confusion Matrix RBF SVM Risky Decision Boys vs Girls.png'));
