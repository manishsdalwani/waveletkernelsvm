function[bestc, bestsigma, bestcv] = OneHyperPar(Range1,Range2,Kernel,dataRowNumber,FeatMat1,FeatMat2,cvloop_parmselect,labels)
...
for i = 1:length(Range1)
    ...
    for j = 1:length(Range2)
        ...
        K =  [ (1:dataRowNumber)', Kernel(FeatMat1,FeatMat2, sigma)];
