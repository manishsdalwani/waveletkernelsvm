...
saveas(h,sprintf('ROI%s_ROC_RBFSVM_Cautious_BoysGirls_%d.png',rois,k)); % will create FIG1, FIG2,...
end
...
saveas(h,sprintf('ROI%sConfusion Matrix RBF SVM Cautious Decision Boys vs Girls.png',rois));
...
dlmwrite('RBF_Cautious_Boys_vs_Girls.csv', finaldatasave, 'Delimiter',',');      
dlmwrite('bestparams_RBF_Cautious_Boys_vs_Girls.csv', besthyperparameters, 'Delimiter',',');
totaltime = toc;
dlmwrite('timetakenperROI_RBF_Cautious_Boys_vs_Girls.csv', elapsed_time, 'Delimiter',',');