function varargout = wavelet_machine_v7(varargin)
% WAVELET_MACHINE_V7 MATLAB code for wavelet_machine_v7.fig
%      WAVELET_MACHINE_V7, by itself, creates a new WAVELET_MACHINE_V7 or raises the existing
%      singleton*.
%
%      H = WAVELET_MACHINE_V7 returns the handle to a new WAVELET_MACHINE_V7 or the handle to
%      the existing singleton*.
%
%      WAVELET_MACHINE_V7('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in WAVELET_MACHINE_V7.M with the given input arguments.
%
%      WAVELET_MACHINE_V7('Property','Value',...) creates a new WAVELET_MACHINE_V7 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before wavelet_machine_v7_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to wavelet_machine_v7_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help wavelet_machine_v7

% Last Modified by GUIDE v2.5 15-May-2017 10:11:51

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @wavelet_machine_v7_OpeningFcn, ...
                   'gui_OutputFcn',  @wavelet_machine_v7_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before wavelet_machine_v7 is made visible.
function wavelet_machine_v7_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to wavelet_machine_v7 (see VARARGIN)

% Choose default command line output for wavelet_machine_v7
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes wavelet_machine_v7 wait for user response (see UIRESUME)
...
function varargout = wavelet_machine_v7_OutputFcn(hObject, eventdata, handles) 
