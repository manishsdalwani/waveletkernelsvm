function[bestc, bestsigma, bestctrfreq, bestgamma, bestcv] = MorletRBFHyperPar(Range1,Range2,Range3,Range4, dataRowNumber,FeatMat1,FeatMat2,cvloop_parmselect,labels)
    ...
    for j = 1:length(Range2)
        ...
        for ctrfreq = Range3
            ...
            for gamma = Range4
                ...
                if (cv >= bestcv)
                    bestc = 2^log2c; bestsigma = 2^log2g; bestcv = cv; bestctrfreq = ctrfreq; bestgamma=gamma; % selection of optimal hyperparameter
                end
                fprintf('%g %g %g (best c=%g, g=%g, rate=%g)\n', log2c, log2g, cv, bestc, bestsigma, bestcv, bestgamma);
