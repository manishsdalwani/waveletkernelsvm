...
saveas(h,sprintf('Striatum_ROC_MultiscaleMexicanHatSVM_risky_controlspatients_%d.png', k)); % will create FIG1, FIG2,...
end
...
filename = 'striatum_MultiscaleMexicanHat_SVM_controls_vs_patients_risky.xlsx';
...
saveas(h,sprintf('Striatum Confusion Matrix Multiscale Mexican Hat SVM Risky Decision controls vs patients.png'));
