...
saveas(h,sprintf('Striatum_ROC_MexicanHatSVM_Cautious_boysgirls_%d.png',k)); % will create FIG1, FIG2,...
end
...
filename = 'striatum_MexicanHat_SVM_boys_vs_girls_cautious.xlsx';
...
saveas(h,sprintf('Striatum Confusion Matrix MexicanHat SVM Cautious Decision boys vs girls.png'));
