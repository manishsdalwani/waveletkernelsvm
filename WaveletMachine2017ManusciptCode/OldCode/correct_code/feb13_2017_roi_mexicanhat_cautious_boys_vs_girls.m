...
saveas(h,sprintf('ROI%s_ROC_MexicanHatSVM_Cautious_boysgirls_%d.png',rois,k)); % will create FIG1, FIG2,...
end
...
filename = 'roi_MexicanHat_SVM_boys_vs_girls_cautious.xlsx';
...
saveas(h,sprintf('ROI%sConfusion Matrix MexicanHat SVM Cautious Decision boys vs girls.png',rois));
end
