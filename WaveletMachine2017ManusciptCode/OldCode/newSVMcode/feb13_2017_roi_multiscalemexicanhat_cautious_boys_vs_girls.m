...
saveas(h,sprintf('ROI%s_ROC_MultiscaleMexicanHatSVM_cautious_boysgirls_%d.png',rois,k)); % will create FIG1, FIG2,...
end
...
filename = 'roi_MultiscaleMexicanHat_SVM_boys_vs_girls_cautious.xlsx';
...
saveas(h,sprintf('ROI%sConfusion Matrix Multiscale Mexican Hat SVM Cautious Decision boys vs girls.png',rois));
end
