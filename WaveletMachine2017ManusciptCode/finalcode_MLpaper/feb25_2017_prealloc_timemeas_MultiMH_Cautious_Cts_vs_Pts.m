...
saveas(h,sprintf('Wholebrain_ROC_MultiMHSVM_Cautious_controlspatients_%d.png',k)); % will create FIG1, FIG2,...
end
...
saveas(h,sprintf('WholeBrain Confusion Matrix MultiMH SVM Cautious Decision controls vs patients.png'));
...
filename = 'wholebrain_MultiMH_SVM_controls_vs_patients_Cautious.xlsx';
...
saveas(h,sprintf('wholebrain Confusion Matrix MultiMH SVM Cautious Decision controls vs patients.png'));
elapsed_time=toc
dlmwrite('timetaken_MultiMH_Cautious_controls_vs_patients.csv', elapsed_time, 'Delimiter',',');