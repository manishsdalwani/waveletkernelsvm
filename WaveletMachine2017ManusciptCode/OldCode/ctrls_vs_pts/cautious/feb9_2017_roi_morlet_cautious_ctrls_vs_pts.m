...
saveas(h,sprintf('ROC_MorletSVM_cautious_controlspatients_%d.png',k)); % will create FIG1, FIG2,...
end
...
saveas(h,sprintf('Confusion Matrix Morlet SVM Cautious Decision controls vs patients.png'));
