...
saveas(h,sprintf('Striatum_ROC_linearSVM_cautious_controlspatients_%d.png',k)); % will create FIG1, FIG2,...
end
...
filename = 'striatum_RBF_SVM_controls_vs_patients_cautious.xlsx';
...
saveas(h,sprintf('Striatum Confusion Matrix RBF SVM Cautious Decision controls vs patients.png'));
