...
saveas(h,sprintf('ROC_striatum_MultiScaleMexicanHatSVM_Cautious_boysgirls_%d.png',k)); % will create FIG1, FIG2,...
end
...
filename = 'striatum_MultiScaleMexicanHat_SVM_boys_vs_girls_cautious.xlsx';
...
saveas(h,sprintf('Confusion Matrix Striatum Multiscale Mexican Hat SVM Cautious Decision Boys vs Girls.png'));
