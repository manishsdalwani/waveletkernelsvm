...
saveas(h,sprintf('ROI3_ROC_MorletSVM_risky_boysgirls_%d.png',k)); % will create FIG1, FIG2,...
end
...
filename = 'roi_ROI3_MORLET_SVM_boys_vs_girls_risky.xlsx';
...
saveas(h,sprintf('ROI3 Confusion Matrix Morlet SVM Risky Decision Boys vs Girls.png'));
