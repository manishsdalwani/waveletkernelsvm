...
saveas(h,sprintf('ROI%s_ROC_MorletSVM_Cautious_BoysGirls_%d.png',rois,k)); % will create FIG1, FIG2,...
end
...
saveas(h,sprintf('ROI%sConfusion Matrix Morlet SVM Cautious Decision Boys vs Girls.png',rois));
elapsed_time = [elapsed_time toc];
end
dlmwrite('Morlet_Cautious_Boys_vs_Girls.csv', finaldatasave, 'Delimiter',',');      
dlmwrite('bestparams_Morlet_Cautious_Boys_vs_Girls.csv', besthyperparameters, 'Delimiter',',');
totaltime = toc;
dlmwrite('timetakenperROI_Morlet_Cautious_Boys_vs_Girls.csv', elapsed_time, 'Delimiter',',');