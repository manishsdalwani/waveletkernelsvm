...
xlabel('False positive rate')
ylabel('True positive rate')
title('ROC for SVM Classification (Kernel="MexicanHat") during Cautious Decision')
saveas(h,sprintf('Wholebrain_ROC_MexicanHatSVM_Cautious_controlspatients_%d.png',k)); % will create FIG1, FIG2,...
end
...
saveas(h,sprintf('WholeBrain Confusion Matrix MexicanHat SVM Cautious Decision controls vs patients.png'));
...
filename = 'wholebrain_MexicanHat_SVM_controls_vs_patients_Cautious.xlsx';
...
saveas(h,sprintf('wholebrain Confusion Matrix MexicanHat SVM Cautious Decision controls vs patients.png'));
elapsed_time=toc
dlmwrite('timetaken_MH_Cautious_controls_vs_patients.csv', elapsed_time, 'Delimiter',',');