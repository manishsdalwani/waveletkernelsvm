...
saveas(h,sprintf('Wholebrain_ROC_RBFSVM_Risky_boysgirls_%d.png',k)); % will create FIG1, FIG2,...
end
...
saveas(h,sprintf('WholeBrain Confusion Matrix RBF SVM Risky Decision boys vs girls.png'));
...
filename = 'wholebrain_RBF_SVM_boys_vs_girls_Risky.xlsx';
...
saveas(h,sprintf('wholebrain Confusion Matrix RBF SVM Risky Decision boys vs girls.png'));
elapsed_time=toc
dlmwrite('timetaken_RBF_Risky_boys_vs_girls.csv', elapsed_time, 'Delimiter',',');