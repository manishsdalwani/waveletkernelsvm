...
saveas(h,sprintf('ROC_MorletSVM_risky_controlspatients_%d.png',k)); % will create FIG1, FIG2,...
end
...
saveas(h,sprintf('Confusion Matrix Morlet SVM Risky Decision controls vs patients.png'));
