...
saveas(h,sprintf('ROI%s_ROC_MexicanHatSVM_Risky_boysgirls_%d.png',rois,k)); % will create FIG1, FIG2,...
end
...
filename = 'roi_MexicanHat_SVM_boys_vs_girls_Risky.xlsx';
...
saveas(h,sprintf('ROI%sConfusion Matrix MexicanHat SVM Risky Decision boys vs girls.png',rois));
end
