function varargout = wavelet_machine_v4(varargin)
% WAVELET_MACHINE_V4 MATLAB code for wavelet_machine_v4.fig
%      WAVELET_MACHINE_V4, by itself, creates a new WAVELET_MACHINE_V4 or raises the existing
%      singleton*.
%
%      H = WAVELET_MACHINE_V4 returns the handle to a new WAVELET_MACHINE_V4 or the handle to
%      the existing singleton*.
%
%      WAVELET_MACHINE_V4('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in WAVELET_MACHINE_V4.M with the given input arguments.
%
%      WAVELET_MACHINE_V4('Property','Value',...) creates a new WAVELET_MACHINE_V4 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before wavelet_machine_v4_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to wavelet_machine_v4_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help wavelet_machine_v4

% Last Modified by GUIDE v2.5 08-May-2017 13:28:11

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @wavelet_machine_v4_OpeningFcn, ...
                   'gui_OutputFcn',  @wavelet_machine_v4_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before wavelet_machine_v4 is made visible.
function wavelet_machine_v4_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to wavelet_machine_v4 (see VARARGIN)

% Choose default command line output for wavelet_machine_v4
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes wavelet_machine_v4 wait for user response (see UIRESUME)
...
function varargout = wavelet_machine_v4_OutputFcn(hObject, eventdata, handles) 
