...
saveas(h,sprintf('Striatum_ROC_MultiscaleMexicanHatSVM_cautious_controlspatients_%d.png',k)); % will create FIG1, FIG2,...
end
...
filename = 'striatum_MultiscaleMexicanHat_SVM_controls_vs_patients_cautious.xlsx';
...
saveas(h,sprintf('Striatum Confusion Matrix Multiscale Mexican Hat SVM Cautious Decision controls vs patients.png'));
