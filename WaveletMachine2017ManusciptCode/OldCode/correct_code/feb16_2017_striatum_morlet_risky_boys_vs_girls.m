...
test = spm_vol('con_0002_5014.img');
[test_vol, test_xyz] = spm_read_vols(test);
test_masked = test_vol(mask_vol);
% ALLsubs is initialization of the feature matrix
% Preallocate depending on ROI vs. whole brain
ALLsubs=zeros(81, size(test_masked,1));
...
cvMatrix = zeros(1,4305); %will save the nested crossvalidation performance
