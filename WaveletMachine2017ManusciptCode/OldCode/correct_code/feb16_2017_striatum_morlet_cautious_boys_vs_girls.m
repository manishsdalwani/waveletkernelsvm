...
saveas(h,sprintf('Striatum_ROC_morletSVM_cautious_boysgirls_%d.png',k)); % will create FIG1, FIG2,...
end
...
filename = 'striatum_morlet_SVM_boys_vs_girls_cautious.xlsx';
...
saveas(h,sprintf('Striatum Confusion Matrix morlet SVM Cautious Decision boys vs girls.png'));
