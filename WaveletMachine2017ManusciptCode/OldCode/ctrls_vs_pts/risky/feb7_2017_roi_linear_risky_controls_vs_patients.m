...
saveas(h,sprintf('ROC_linearSVM_risky_ctrlspts_%d.png',k)); % will create FIG1, FIG2,...
end
...
% Plot the final Confusion Matrix using plotconfusion from Neural Network Toolbox
h=figure;
groundtruth = reshape(groundtruth, dataRowNumber, 1);
SVMpred = reshape(SVMpred, dataRowNumber, 1);
plotconfusion(groundtruth',SVMpred');
saveas(h,sprintf('Confusion Matrix Linear SVM Risky Decision Controls vs Patients.png'));
