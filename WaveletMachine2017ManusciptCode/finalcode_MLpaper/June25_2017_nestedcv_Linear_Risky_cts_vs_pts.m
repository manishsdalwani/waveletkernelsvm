...
saveas(h,sprintf('ROI%s_ROC_LinearSVM_Risky_controlspatients_%d.png',rois,k)); % will create FIG1, FIG2,...
end
...
saveas(h,sprintf('ROI%sConfusion Matrix Linear SVM Risky Decision controls vs patients.png',rois));
elapsed_time = [elapsed_time toc];
end
dlmwrite('Linear_Risky_controls_vs_patients.csv', finaldatasave, 'Delimiter',',');      
dlmwrite('bestparams_Linear_Risky_controls_vs_patients.csv', besthyperparameters, 'Delimiter',',');
totaltime = toc;
dlmwrite('timetakenperROI_Linear_Risky_controls_vs_patients.csv', elapsed_time, 'Delimiter',',');