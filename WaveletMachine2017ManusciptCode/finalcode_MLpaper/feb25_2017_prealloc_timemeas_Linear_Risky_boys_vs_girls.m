...
saveas(h,sprintf('Wholebrain_ROC_LinearSVM_Risky_boysgirls_%d.png',k)); % will create FIG1, FIG2,...
end
...
saveas(h,sprintf('WholeBrain Confusion Matrix Linear SVM Risky Decision boys vs girls.png'));
...
T4 = cell2table({'BalancedAccuracy', 'Kappa','Precision', 'Recall', 'F1score', 'AUC'; 100*bal_Accuracy,kappa, Precision_weighted, Recall_weighted, Fscore_weighted, auc_roc_final(2)});

%writetable helps to save the file into an excel file
filename = 'wholebrain_Linear_SVM_boys_vs_girls_Risky.xlsx';
...
saveas(h,sprintf('wholebrain Confusion Matrix Linear SVM Risky Decision boys vs girls.png'));
elapsed_time=toc
dlmwrite('timetaken_Linear_Risky_boys_vs_girls.csv', elapsed_time, 'Delimiter',',');