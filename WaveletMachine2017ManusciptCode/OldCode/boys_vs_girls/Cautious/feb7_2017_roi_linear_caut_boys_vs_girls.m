...
saveas(h,sprintf('ROC_LinearVM_cautious_boysvgirls_%d.png',k)); % will create FIG1, FIG2,...
end
...
saveas(h,sprintf('Confusion Matrix Linear SVM Cautious Decision Boys vs Girls.png'));
