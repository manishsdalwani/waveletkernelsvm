...
saveas(h,sprintf('Striatum_ROC_MexicanHatSVM_Risky_boysgirls_%d.png',k)); % will create FIG1, FIG2,...
end
...
filename = 'striatum_MexicanHat_SVM_boys_vs_girls_Risky.xlsx';
...
saveas(h,sprintf('Striatum Confusion Matrix MexicanHat SVM Risky Decision boys vs girls.png'));
