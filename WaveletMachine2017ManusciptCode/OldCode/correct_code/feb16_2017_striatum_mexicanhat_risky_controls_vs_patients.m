...
saveas(h,sprintf('Striatum_ROC_MexicanHatSVM_risky_controlspatients_%d.png',k)); % will create FIG1, FIG2,...
end
...
filename = 'striatum_MexicanHat_SVM_controls_vs_patients_risky.xlsx';
...
saveas(h,sprintf('Striatum Confusion Matrix MexicanHat SVM Risky Decision controls vs patients.png'));
