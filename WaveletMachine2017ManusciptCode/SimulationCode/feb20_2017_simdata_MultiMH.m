...
% The modified MultiScaleMultiMH Wavelet Kernel with the tuned parameters
...
xlabel('False positive rate')
ylabel('True positive rate')
title('ROC for SVM Classification (Kernel="MultiMH")');
saveas(h,sprintf('simdata_ROC_MultiMHSVM_%d.png',k)); % will create FIG1, FIG2,...
end
...
filename = 'simdata_MultiMH_SVM.xlsx';
...
saveas(h,sprintf('simdata Confusion Matrix MultiMH SVM.png'));