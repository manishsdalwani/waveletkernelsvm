...
saveas(h,sprintf('ROI2_ROC_RBFSVM_risky_boysgirls_%d.png',k)); % will create FIG1, FIG2,...
end
...
filename = 'roi_ROI2_RBF_SVM_boys_vs_girls_risky.xlsx';
...
saveas(h,sprintf('ROI2 Confusion Matrix RBF SVM Risky Decision Boys vs Girls.png'));
