...
saveas(h,sprintf('ROI%s_ROC_MexicanHatSVM_risky_controlspatients_%d.png',rois,k)); % will create FIG1, FIG2,...
end
...
filename = 'roi_MexicanHat_SVM_controls_vs_patients_risky.xlsx';
...
saveas(h,sprintf('ROI%sConfusion Matrix MexicanHat SVM Risky Decision controls vs patients.png',rois));
end
