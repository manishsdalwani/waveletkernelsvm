...
saveas(h,sprintf('Wholebrain_ROC_MultiMHSVM_Cautious_boysgirls_%d.png',k)); % will create FIG1, FIG2,...
end
...
saveas(h,sprintf('WholeBrain Confusion Matrix MultiMH SVM Cautious Decision boys vs girls.png'));
...
filename = 'wholebrain_MultiMH_SVM_boys_vs_girls_Cautious.xlsx';
...
saveas(h,sprintf('wholebrain Confusion Matrix MultiMH SVM Cautious Decision boys vs girls.png'));
elapsed_time=toc
dlmwrite('timetaken_MultiMH_Cautious_boys_vs_girls.csv', elapsed_time, 'Delimiter',',');