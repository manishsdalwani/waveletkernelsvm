...
saveas(h,sprintf('Wholebrain_ROC_AdaptiveSVM_Risky_controlspatients_%d.png',k)); % will create FIG1, FIG2,...
end
...
saveas(h,sprintf('WholeBrain Confusion Matrix Adaptive SVM Risky Decision controls vs patients.png'));
...
filename = 'wholebrain_Adaptive_SVM_controls_vs_patients_Risky.xlsx';
...
saveas(h,sprintf('wholebrain Confusion Matrix Adaptive SVM Risky Decision controls vs patients.png'));
elapsed_time=toc
dlmwrite('timetaken_Adaptive_Risky_controls_vs_patients.csv', elapsed_time, 'Delimiter',',');