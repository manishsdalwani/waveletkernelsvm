...
saveas(h,sprintf('ROC_linearSVM_risky_boysgirls_%d.png',k)); % will create FIG1, FIG2,...
end
...
saveas(h,sprintf('Confusion Matrix Linear SVM Risky Decision Boys vs Girls.png'));
