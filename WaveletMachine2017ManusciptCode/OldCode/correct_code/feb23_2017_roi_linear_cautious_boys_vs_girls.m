...
% it to a table format
      T{rois} = cell2table({'Accuracy', 'MeanAbsoluteError', 'Kappa', 'TP', 'FP', 'Precision', 'Recall', 'F1score', 'AUC', 'Predboys', 'Predgirls'; mean_Accuracy, mean_absolute_error, kappa, TP_weighted, FP_weighted, Precision_weighted, Recall_weighted, Fscore_weighted, mean(auc_roc_final), round(Pred_boys), round(Pred_girls)});
      T2{rois} = cell2table({'BalancedAccuracy', 'Precisionboys', 'Precisiongirls', 'Recallboys', 'Recallgirls',  'Sensitivityboys', 'Sensitivitygirls', 'Specificityboys', 'Specificitygirls', 'Fscoreboys', 'Fscoregirls', 'FPrateboys', 'FPrategirls', 'TPrateboys', 'TPrategirls';100*bal_Accuracy, precision_boys, precision_girls, Recall_boys, Recall_girls, sensitivity_boys, sensitivity_girls, specificity_boys, specificity_girls, Fscore_boys, Fscore_girls, FP_rate_boys, FP_rate_girls, TP_rate_boys, TP_rate_girls});
      T3{rois} = cell2table({'BESTC'; bestc});
      T4{rois} = cell2table({'BalancedAccuracy', 'Kappa','Precision', 'Recall', 'F1score', 'AUC'; 100*bal_Accuracy, kappa, Precision_weighted, Recall_weighted, Fscore_weighted, mean(auc_roc_final)});
...
filename = 'roi_LINEAR_SVM_boys_vs_girls_Cautious.xlsx';
